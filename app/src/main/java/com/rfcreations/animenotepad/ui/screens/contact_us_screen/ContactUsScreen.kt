package com.rfcreations.animenotepad.ui.screens.contact_us_screen
    ...
    Scaffold(topBar = {
        ...
        Column(
            ...
            SocialMediaColumn(
                ...
                urlToOpen = stringResource(R.string.telegram_link)
            )
            SocialMediaColumn(
                modifier = Modifier.fillMaxWidth(),
                socialMediaName = stringResource(R.string.whatsapp),
                R.drawable.whatsapp_icon,
                urlToOpen = stringResource(R.string.whatsapp_link)
            )
        }
    }
}
