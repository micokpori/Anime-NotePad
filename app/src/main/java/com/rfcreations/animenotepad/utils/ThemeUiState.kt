...
class ThemeUiState @Inject constructor(
    ...
    /**
     * Updates the selected theme value in both the internal state and user preferences.
     *
    ...
    /**
     * Toggles the dynamic theme preference by inverting its current value.
     * Updates the internal state and user preferences accordingly.
     */
    ...
    /**
     * Updates the dark theme value directly in the internal state.
     * This function is likely used when reacting to user interaction or system settings changes.
     *
